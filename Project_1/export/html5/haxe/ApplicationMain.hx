...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Project_1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Project_1", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Project_1";
		app.meta["name"] = "Project_1";
